 ...
 */
#ifndef CONSTANT_VELOCITY_MOBILITY_MODEL_BOUNDED_H
#define CONSTANT_VELOCITY_MOBILITY_MODEL_BOUNDED_H
 ...
 */
class ConstantVelocityMobilityModelBounded : public MobilityModel 
{
public:
  /**
   ...
   * speed (0,0,0).
   */
  ConstantVelocityMobilityModelBounded ();
  virtual ~ConstantVelocityMobilityModelBounded ();
